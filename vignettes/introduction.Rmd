...
graphCr("1 -- 2 -- 3", representation = "graphNEL")
```
...
```{r}
graphCr("1 -- 2 -- 4 -- 5, 2 -- 3 -- 5", representation = "graphNEL")
graphCr("1 -> 2 -> 3 -> 4, 2 <-> 4", representation = "ggm")
```
...
gr2 %G% degree(Nodes=c(2,4))
degree(convert(gr2, "graphNEL"), Nodes=c(2,4))
```
